...
const DetailNewsItem = ({ index, subHeading, body, align, img }) => (
  <>
    ...
    {body && <p className={`${align} ${align === 'text-right' ? 'leading-[250%]' : 'leading-[200%]'}`}>{body}</p>}
    {img.url && (
        ...
        <article className='flex flex-col gap-16 sm:p-4 lg:pl-12'>
          <section className='flex flex-col items-start lg:flex-row'>
            ...
            <div className='lg:basis-7/12 xl:basis-8/12'>
              ...
              <h2 className='mb-12 mt-8 text-2xl/normal font-bold text-sky-500 sm:text-3xl/normal lg:text-4xl/normal 2xl:text-5xl/normal'>{title}</h2>
