...
export const objectives = [
  {
    ...
    date: "",
    points: [
      "Mengintegrasikan pelajaran Al Qur'an dalam kurikulum sekolah dan menyediakan pengajaran yang komprehensif tentang isi, tafsir, dan aplikasi praktis Al Qur'an.",
      "Menerapkan nilai-nilai etika, kejujuran, kesabaran, kasih sayang, dan toleransi dalam setiap aspek pengajaran dan kegiatan di sekolah.",
    ],
  },
  {
    title:
      "Membiasakan anak melaksanakan kegiatan yang bermanfaat bagi diri dan lingkungannya",
    company_name: "Visi & Misi Kami",
    icon: people,
    iconBg: "#ffffff",
    date: "",
    points: [
      "Mengajak anak terlibat dalam kegiatan sosial dan membantu anak untuk mengembangkan rasa empati dan kesadaran sosial.",
      "Melibatkan anak dalam proyek lingkungan, serta mengajarkan anak tentang pentingnya menjaga alam dan bertanggung jawab terhadap lingkungan tempat tinggal mereka.",
      "Melibatkan anak dalam kegiatan keluarga. Ini membantu anak untuk menghargai nilai-nilai keluarga, memperkuat hubungan antaranggota keluarga, dan mengajarkan mereka keterampilan sehari-hari.",
    ],
  },
  {
  ...
  },
  {
    ...
    date: "",
    points: [
      "Menyediakan program ekstrakurikuler yang berfokus pada pengembangan bakat siswa, program-program ini memberikan kesempatan bagi siswa untuk mengasah keterampilan dan minat siswa.",
      "Menyediakan dukungan dan bimbingan bagi siswa yang ingin mengembangkan minat dan bakat, dapat berupa pengarahan untuk memilih program pendidikan atau pelatihan yang sesuai",
    ],
  },
  {
    title:
      "Mengoptimalkan pendayagunaan alam sekitar sebagai sarana pembelajaran dan meningkatkan literasi",
    company_name: "Visi & Misi Kami",
    icon: forest,
    iconBg: "#ffffff",
    date: "",
    points: [
      "Mengajak siswa untuk melakukan penelitian lapangan di sekitar lingkungan siswa, hal ini akan membantu meningkatkan pemahaman siswa tentang alam sekitar dan mendorong rasa kepedulian terhadap lingkungan.",
      "mengjarkan siswa tentang pertanian organik, budidaya tanaman, pemeliharaan kebun, dan teknik pengolahan tanah yang ramah lingkungan, sehingga siswa dapat memahami pentingnya menjaga keberlanjutan lingkungan dan nilai-nilai pertanian berkelanjutan.",
    ],
  },
];
...
export const quotesList = [
  ...
  {
    id: `quotes-2`,
    content: `Qui quis sunt omnis mollitia libero minus. Amet sunt error. Maiores dolores nostrum. Ullam iure veritatis corporis sequi tempora assumenda ab. Voluptas illo qui quaerat facilis ab unde eum. 
              Expedita ab id natus molestiae. Molestiae dolorem incidunt dolorem et tempore corporis commodi perspiciatis voluptatem. Est et est id.
              Dolorem ea animi ut cupiditate qui. Aut non aut est ullam. Aut saepe numquam harum fuga est. Dolorem aut consectetur distinctio facilis. Et est sapiente nihil. Ut veniam error ratione et dolorum odit.`,
    author: `Hugo Thiel`,
  },
  {
    id: `quotes-3`,
